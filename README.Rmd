...
`pollinatorSDM` est un package R complet pour la modélisation de la distribution des pollinisateurs et l'évaluation des services de pollinisation. Il combine données d'occurrence, modèles de distribution d'espèces (SDM), analyse paysagère et cartographie du déficit de pollinisation pour l'agroécologie.
